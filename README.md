...
* Wayland Compositor / WM: [Sway](https://github.com/swaywm/sway) / [SwayFX](https://github.com/WillPower3309/swayfx) \
* Bar: [Waybar](https://github.com/Alexays/Waybar) \
* Launcher: [Rofi](https://github.com/davatorium/rofi) \
* Terminal: [Kitty](https://github.com/kovidgoyal/kitty) \
* Colourscheme: A mixture of [Nord](https://www.nordtheme.com/) & whatever my current wallpaper is. \
